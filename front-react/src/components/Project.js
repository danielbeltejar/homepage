...
import ProjectCard from './ProjectCard.tsx'; // Adjust the path as needed

const projects = [

  {
    videoSrc: "assets/videos/fym.webm",
    posterSrc: "assets/videos/fym.webm",
  ...
  {
    videoSrc: "assets/videos/bigmac.webm",
    posterSrc: "assets/images/bigmac-index.png",
  ...
  {
    videoSrc: "assets/videos/stock.webm",
    posterSrc: "assets/images/stock-index.png",
  ...
  },
  {
    ...
    posterSrc: "assets/videos/kafka.webm",
...
const Projects = () => {
  return (
    <div>
      ...
      <h2 class="text-accent dark:text-dark-accent font-bold text-1 group-hover:cursor-pointer group-hover:pl-m group-hover:underline underline-offset-4 transition-all duration-300"
        onclick="location.href='#projects';">Projects</h2>
    </div><p class="mt-xs mb-xl text-11">
      ...
      </p><div class="h-full flex justify-center w-full">
        <div class="h-full flex lg:flex-row lg:flex-wrap lg:content-start gap-s lg:justify-center lg:overflow-x-auto overflow-x-scroll">
